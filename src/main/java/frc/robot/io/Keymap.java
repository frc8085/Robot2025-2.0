...
public class Keymap {
    ...
    public static class Layout {
        ...
        public static double driverLeftTrigger = Controllers.driverController.getLeftTriggerAxis();
        public static double driverRightTrigger = Controllers.driverController.getRightTriggerAxis();
        ...
        public static double operatorLeftX = Controllers.operatorController.getLeftX();
        public static double operatorLeftY = Controllers.operatorController.getLeftY();
        public static double operatorRightX = Controllers.operatorController.getRightX();
        public static double operatorRightY = Controllers.operatorController.getRightY();
        public static double operatorLeftTrigger = Controllers.operatorController.getLeftTriggerAxis();
        public static double operatorRightTrigger = Controllers.operatorController.getRightTriggerAxis();
