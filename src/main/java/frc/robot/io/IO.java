...
public class IO {
    ...
    public void init() {
                ...
                final Trigger altPositionRight = Keymap.Layout.operatorRightBumper;
                // final Trigger zeroElevator = operatorController.start();
                final Trigger zeroPivot = Keymap.Layout.operatorStartButton;
                ...
                final Trigger altButton =  Keymap.Layout.driverBackButton;
                ...
                final Trigger toggleClimber = Keymap.Layout.operatorBackButton;
                 ...
                 final Trigger pivotCounterClockwise = Keymap.Controllers.operatorController.axisLessThan(4,
                                 -0.25);
                ...
                zeroPivot.onTrue(new InitializePivotAndElevator(RobotSubsystems.pivot, RobotSubsystems.elevator));
                zeroPivot.and(altPositionRight).onTrue(new ZeroElevator(RobotSubsystems.elevator));
                ...
                ejectCoral.and(altButton).onTrue(new DropCoral(RobotSubsystems.coral,
