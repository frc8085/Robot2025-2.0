...
public class IO {
        ...
        public void init(RobotContainer robotContainer) {
                ...
                // final Trigger raiseElevator =
                // Keymap.Controllers.operatorController.axisLessThan(1, -0.25);
                // final Trigger lowerElevator =
                // Keymap.Controllers.operatorController.axisGreaterThan(1, 0.25);
                // final Trigger pivotClockwise =
                // Keymap.Controllers.operatorController.axisGreaterThan(4, 0.25);
                // final Trigger pivotCounterClockwise =
                // Keymap.Controllers.operatorController.axisLessThan(4, -0.25);
                ...
                // // Limelight Buttons
                // limelightTrigger1.onTrue(new SwerveDriveTargetReef(robotContainer.drivetrain,
                // true)).onFalse(
                ...
                // .onTrue(new PickUpCoralFromSource(robotContainer.coral,
                ...
                // new ToCoralSourceManual(robotContainer.elevator, robotContainer.pivot,
                // false),
                ...
                // manualAlgae.onTrue(new RunCommand(() -> robotContainer.algae.pickup(),
                ...
                // algaeGround.onTrue(new PickUpAlgaeFromGround(robotContainer.algae,
                // robotContainer.elevator,
                // robotContainer.pivot));
                ...
                // algaeProcessor.onTrue(new ToAlgaeGround(robotContainer.elevator,
                // robotContainer.pivot));
...
// .onTrue(new ToCoralDropOff1(robotContainer.elevator, robotContainer.pivot,
// true));
// coralDropOff2.and(altButtonOperator)
// .onTrue(new ToCoralDropOff2(robotContainer.elevator, robotContainer.pivot,
// true));
// coralDropOff3.and(altButtonOperator)
// .onTrue(new ToCoralDropOff3(robotContainer.elevator, robotContainer.pivot,
// true));
...
// pivotClockwise
// .onTrue(new InstantCommand(robotContainer.pivot::start,
// robotContainer.pivot))
// .onFalse(new InstantCommand(robotContainer.pivot::holdPivotArmManual,
// robotContainer.pivot));
// pivotCounterClockwise.onTrue(new
// InstantCommand(robotContainer.pivot::reverse, robotContainer.pivot))
// .onFalse(new InstantCommand(robotContainer.pivot::holdPivotArmManual,
// robotContainer.pivot));
...
// new InstantCommand(robotContainer.elevator::moveDown,
// robotContainer.elevator)
// .andThen(new WaitUntilCommand(
