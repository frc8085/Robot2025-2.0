...
public class PivotToCoralPickUp extends Command {
    PivotSubsystem pivot;

    public PivotToCoralPickUp(PivotSubsystem pivot) {
        this.pivot = pivot;
    ...
    @Override
    public void execute() {
        pivot.setPos(WindmillState.CoralPickup.getPivotArmAngle());
    }

    @Override
    public boolean isFinished() {
        return Math.abs(pivot.getCurrentPosition()
                - WindmillState.CoralPickup.getPivotArmAngle()
