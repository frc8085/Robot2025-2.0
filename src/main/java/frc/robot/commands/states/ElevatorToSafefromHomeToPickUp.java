...
public class ElevatorToSafefromHomeToPickUp extends Command {
    ElevatorSubsystem elevatorSubsystem;
    WindmillState prevState;

    public ElevatorToSafefromHomeToPickUp(ElevatorSubsystem elevatorSubsystem, WindmillState prevState) {
    ...
    public boolean isFinished() {
        ...
        return prevState == WindmillState.Home
