package frc.robot.commands.aautoCommands;
...
public class AutoDriveAlignBarge extends Command {
    ...
    public AutoDriveAlignBarge(DriveSubsystem driveSubsystem) {
    ...
    public void initialize() {
        ...
        // We want to go to specified X and Y and rotation
        this.targetPose = new Pose2d(targetX, targetY, targetRot);
