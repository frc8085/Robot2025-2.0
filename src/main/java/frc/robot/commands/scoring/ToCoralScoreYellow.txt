...
public class ToCoralScoreYellow extends SequentialCommandGroup {
    public ToCoralScoreYellow(CoralSubsystem coral, ElevatorSubsystem elevator, PivotSubsystem pivot,
    ...
    public void scoreCoral(CoralSubsystem coral, ElevatorSubsystem elevator, PivotSubsystem pivot,
        ...
        switch (RobotContainer.coralLevel) {
            case ONE:
                addCommands(
                        new ToCoralDropOff1(elevator, pivot, true),
                        new ParallelCommandGroup(
                                new WaitUntilCommand(elevator::elevatorAtCoralDropOff1Height),
                                new WaitUntilCommand(() -> pivot.pivotAtCoralDropOffAngle(true))),
            ...
            case TWO:
                addCommands(
                        new ToCoralDropOff2(elevator, pivot, true),
                        new ParallelCommandGroup(
            ...
            case THREE:
                addCommands(
                        new ToCoralDropOff3(elevator, pivot, true),
                        new ParallelCommandGroup(
            ...
            case FOUR:
                addCommands(
                        new ToCoralDropOff4(elevator, pivot, true),
                        new ParallelCommandGroup(
                                new WaitUntilCommand(elevator::elevatorAtCoralDropOff4Height),
                                new WaitUntilCommand(() -> pivot.pivotAtCoral4DropOffAngle(true))),
                        new DropCoral(coral, elevator, pivot),
                        new ToHomeCommand(elevator, pivot, coral));
