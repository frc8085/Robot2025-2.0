...
public class AlignToAprilTagBlue extends Command {
    ...
    public AlignToAprilTagBlue(DriveSubsystem drive, LimelightSubsystem limelight) {
        this.drive = drive;
    ...
    public void initialize() {
        int id = limelight.getID("limelight-blue");
        switch (id) {
            case 6:
                id = -150;
                break;
    ...
    public boolean isFinished() {
        ...
        return (turnPID.atSetpoint() || !this.limelight.hasTarget(this.limelight.getName()));
    }
