...
public class AutoOppoToL4 extends SequentialCommandGroup {
    public AutoOppoToL4(DriveSubsystem driveSubsystem, AlgaeSubsystem algaeSubsystem,
            ElevatorSubsystem elevatorSubsystem, PivotSubsystem pivotSubsystem, CoralSubsystem coralSubsystem) {

        addCommands(
                new SwerveDriveChoreoFollow(
                        driveSubsystem,
                        Choreo.<SwerveSample>loadTrajectory("OppoBargeToReef22"), true),
                new AutoScoreCoralL4(algaeSubsystem, elevatorSubsystem, pivotSubsystem, coralSubsystem, driveSubsystem,
                        isScheduled()),
                new SwerveDriveChoreoFollow(
                        driveSubsystem,
