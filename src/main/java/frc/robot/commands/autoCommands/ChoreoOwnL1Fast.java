...
public class ChoreoOwnL1Fast extends SequentialCommandGroup {
        public ChoreoOwnL1Fast(DriveSubsystem driveSubsystem, PivotSubsystem pivotSubsystem,
                ...
                Optional<Trajectory<SwerveSample>> path1 = Choreo.loadTrajectory("2All1");
                Optional<Trajectory<SwerveSample>> path2 = Choreo.loadTrajectory("2All2-3");
