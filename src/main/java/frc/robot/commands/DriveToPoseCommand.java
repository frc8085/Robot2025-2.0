...
public class DriveToPoseCommand extends Command {
    ...
    public DriveToPoseCommand(DriveSubsystem driveSubsystem, String direction) {
    ...
    private void updateTargetPose() {
        ...
        if (targetPose != null && m_poseEstimator.getEstimatedPosition().equals(targetPose)) {
        ...
        cache = getTargetPose((int) aprilTagCache);
